...
import Server.ProcessServer.ProcessServer;
import tools.People;
...
public class Client {
    ...
    public void showAllPeople(){
        ArrayList<People> list = processServer.showAll();
        for (People p :
                list) {
...
//        sc.close();
        processServer.add(name, addr, tel);
    }
...
//        sc.close();
        ...
        if(processServer.change(name, newName, newAddr, newTel))
...
//        Scanner sc = new Scanner(System.in);
        ...
        String name = sc.nextLine();
//        sc.close();
        People people = processServer.search(name);
        if(people != null)
    ...
    public void save(){
        processServer.saveInfo();
    }
    public void load(){
        processServer.LoadInfo();
    }
}
